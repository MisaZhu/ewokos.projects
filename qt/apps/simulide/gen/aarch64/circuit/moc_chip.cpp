...
QT_MOC_LITERAL(1, 5, 7), // "Package"
QT_MOC_LITERAL(2, 13, 12) // "Logic_Symbol"

    },
    "Chip\0Package\0Logic_Symbol"
};
...
void Chip::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::ReadProperty) {
        auto *_t = static_cast<Chip *>(_o);
        (void)_t;
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< QString*>(_v) = _t->package(); break;
        case 1: *reinterpret_cast< bool*>(_v) = _t->logicSymbol(); break;
        default: break;
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: _t->setPackage(*reinterpret_cast< QString*>(_v)); break;
        case 1: _t->setLogicSymbol(*reinterpret_cast< bool*>(_v)); break;
        default: break;
        }
