...
QT_MOC_LITERAL(3, 27, 8), // "backward"
QT_MOC_LITERAL(4, 36, 16), // "replaceRequested"
QT_MOC_LITERAL(5, 53, 19), // "replaceAllRequested"
QT_MOC_LITERAL(6, 73, 6) // "closed"

    },
    "SearchBar\0searchRequested\0\0backward\0"
    "replaceRequested\0replaceAllRequested\0"
    "closed"
};
...
void SearchBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->searchRequested((*reinterpret_cast< bool(*)>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SearchBar::searchRequested)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SearchBar::replaceRequested)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (SearchBar::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SearchBar::replaceAllRequested)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (SearchBar::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SearchBar::closed)) {
                *result = 3;
                return;
            }
        }
...
// SIGNAL 0
void SearchBar::searchRequested(bool _t1)
{
...
// SIGNAL 1
void SearchBar::replaceRequested()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void SearchBar::replaceAllRequested()
{
