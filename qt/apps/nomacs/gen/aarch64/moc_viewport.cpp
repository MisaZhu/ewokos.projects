...
QT_MOC_LITERAL(1, 9, 11), // "zoomChanged"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 4), // "zoom"
QT_MOC_LITERAL(4, 27, 13), // "nextRequested"
QT_MOC_LITERAL(5, 41, 17) // "previousRequested"

    },
    "Viewport\0zoomChanged\0\0zoom\0nextRequested\0"
    "previousRequested"
};
...
void Viewport::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->previousRequested(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Viewport::*)(qreal );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Viewport::zoomChanged)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Viewport::nextRequested)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (Viewport::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Viewport::previousRequested)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void Viewport::zoomChanged(qreal _t1)
{
...
// SIGNAL 1
void Viewport::nextRequested()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void Viewport::previousRequested()
{
