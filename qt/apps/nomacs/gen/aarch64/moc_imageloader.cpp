...
QT_MOC_LITERAL(3, 26, 13) // "folderChanged"

    },
    "ImageLoader\0imageChanged\0\0folderChanged"
};
...
void ImageLoader::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ImageLoader::imageChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (ImageLoader::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ImageLoader::folderChanged)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void ImageLoader::folderChanged()
{
