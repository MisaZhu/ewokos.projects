...
QT_MOC_LITERAL(3, 15, 16) // "structureChanged"

    },
    "Scene\0changed\0\0structureChanged"
};
...
void Scene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Scene::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Scene::changed)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Scene::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Scene::structureChanged)) {
                *result = 1;
                return;
            }
        }
