...
QT_MOC_LITERAL(3, 27, 11), // "MeshEntity*"
QT_MOC_LITERAL(4, 39, 3), // "ent"
QT_MOC_LITERAL(5, 43, 6), // "fitAll"
QT_MOC_LITERAL(6, 50, 10), // "setStdView"
QT_MOC_LITERAL(7, 61, 4) // "view"

    },
    "Viewport\0selectionChanged\0\0MeshEntity*\0"
    "ent\0fitAll\0setStdView\0view"
};
...
void Viewport::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->selectionChanged((*reinterpret_cast< MeshEntity*(*)>(_a[1]))); break;
        case 1: _t->fitAll(); break;
        case 2: _t->setStdView((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Viewport::*)(MeshEntity * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Viewport::selectionChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Viewport::selectionChanged(MeshEntity * _t1)
{
