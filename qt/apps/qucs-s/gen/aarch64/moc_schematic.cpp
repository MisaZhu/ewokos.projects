...
QT_MOC_LITERAL(3, 19, 16) // "structureChanged"

    },
    "Schematic\0changed\0\0structureChanged"
};
...
void Schematic::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<Schematic *>(_o);
        (void)_t;
        switch (_id) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Schematic::changed)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Schematic::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Schematic::structureChanged)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject Schematic::staticMetaObject = { {
    ...
    qt_meta_stringdata_Schematic.data,
    qt_meta_data_Schematic,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 0
void Schematic::changed()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void Schematic::structureChanged()
{
